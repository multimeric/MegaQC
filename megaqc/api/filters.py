...
def build_filter_query(filters):
        ...
        for filter in filter_group:
            if filter['type'] == 'daterange':
                ...
                and_filters.append(
                    ...
                    & add_operator(ReportMeta.report_meta_value, filter['cmp'], filter['value'])
                )
                ...
                and_filters.append(
                    ...
                    & add_operator(SampleData.value, filter['cmp'], filter['value'])
                )
            else:
    ...
    query = db.session.query(
        ...
        PlotData, PlotData.sample_id == Sample.sample_id,
        isouter=True
    ).join(
